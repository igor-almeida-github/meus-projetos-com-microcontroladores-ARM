...
drivers/Src/stm32f407xx_spi_driver.o: ../drivers/Src/stm32f407xx_spi_driver.c drivers/Src/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m4 -std=gnu11 -g3 -DDEBUG -DSTM32 -DSTM32F407G_DISC1 -DSTM32F4 -DSTM32F407VGTx -c -I../Inc -I"/home/igor/Documentos/microcontroladores/ARM/Cursos/003MCU1/006stm32f4xx_drivers/bsp" -I"/home/igor/Documentos/microcontroladores/ARM/Cursos/003MCU1/006stm32f4xx_drivers/drivers/Inc" -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"drivers/Src/stm32f407xx_spi_driver.d" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@"
drivers/Src/stm32f407xx_usart_driver.o: ../drivers/Src/stm32f407xx_usart_driver.c drivers/Src/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m4 -std=gnu11 -g3 -DDEBUG -DSTM32 -DSTM32F407G_DISC1 -DSTM32F4 -DSTM32F407VGTx -c -I../Inc -I"/home/igor/Documentos/microcontroladores/ARM/Cursos/003MCU1/006stm32f4xx_drivers/bsp" -I"/home/igor/Documentos/microcontroladores/ARM/Cursos/003MCU1/006stm32f4xx_drivers/drivers/Inc" -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"drivers/Src/stm32f407xx_usart_driver.d" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@"
