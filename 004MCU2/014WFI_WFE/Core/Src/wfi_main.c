 ...
 *===================================================================================================
 * Current consumption without WFI      										72 Mhz - 24.40 mA
 * Current consumption with WFI     										    72 Mhz - 13.90 mA
 * Current consumption with WFI and Analog Pins								    72 Mhz - 13.75 mA
 *===================================================================================================
 *
 * WFI - Wait for interrupt - sleep immediately and wake up when an interrupt is called
 */
